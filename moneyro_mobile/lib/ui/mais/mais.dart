...
class _MaisPageState extends State<MaisScreen> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      ...
      children: <Widget>[
        Cabecalho(
            titulo: "Você", icone: Icons.face_rounded, cor: Colors.cyan[500]),
                ...
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          usuario.saldo.toStringAsFixed(2).replaceAll(".", ","),
                          style: TextStyle(
                              height: 0.8,
                              fontWeight: FontWeight.w900,
                              fontSize: 55,
        ...
        Container(
            height: MediaQuery.of(context).size.height / 3, child: Text("")),
