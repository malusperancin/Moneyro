...
class _LoginPageState extends State<LoginScreen> {
  ...
  void _login() { 
    Usuario usuario = new Usuario.login(_apelidoController.text, _senhaController.text);

    //APIServices.login(usuario).then((response) {
      //if (response.statusCode == 200) {

        usuario = new Usuario(1, 'Teste', 'Testinho', 'teste@hotmail.com', '999', new DateTime(2004,2,12), '2', 'senha', 'cidade', 'SP', false, true, 5.0, false, 1, 0);
